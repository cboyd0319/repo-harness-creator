...
9. Deferred: add blueprint mode only as explicit opt-in.
...
10. Implemented as local evidence contracts: measured real-agent evals.
...
11. Implemented: source-verified platform adapter metadata.
...
12. Implemented: optional sandbox/container readiness profile.
