...
- Generated repo harness: files HarnessForge writes into a target repository.
  ...
  private state, release process, local paths, or local agent/tooling mandates.
...
| Workflow surfaces | Maintainers | Keep the live scheduled self-heal/research workflow, the optional generated CI scaffold, and published composite Action behavior separate. Live workflows may refresh HarnessForge research metadata. The generated CI scaffold is manual by default. The published Action is input-driven and does not schedule, commit, push, or open pull requests. |
